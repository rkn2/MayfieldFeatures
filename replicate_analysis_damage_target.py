...
def get_feature_sets():
    ...
    # Filter out leakage columns (damage related) as requested
...
def run_analysis(df, numeric_cols, cat_cols, hazard_cols):
    ...
    settings = {
        ...
        # 'Hazard-Inclusive': numeric_cols + cat_cols + hazard_cols # Removed as per user request to have only one model
    }
